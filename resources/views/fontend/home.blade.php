                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-5 align-self-center">
                        <div class="logo text-md-left text-center">
                            <a class="main-logo" href="index.html"><img src="{{asset('assetsFontend/img/logo.png')}}" alt="img"></a>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-7 text-md-right text-center">
                        <a href="#" class="adbar-right">
                            <img src="{{asset('assetsFontend/img/add/1.png')}}" alt="img">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="container nav-container">
                <div class="responsive-mobile-menu">
                    <div class="logo d-lg-none d-block">
                        <a class="main-logo" href="index.html"><img src="{{asset('assets/img/logo.png')}}" alt="img"></a>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="thumb after-left-top">
                            <img src="{{asset('assetsFontend/img/banner/1.png')}}" alt="img">
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-white">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/1.png')}}" alt="img">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-white">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/2.png')}}" alt="img">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-white">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/3.png')}}" alt="img">
                            <a class="tag-base tag-blue" href="#">Tech</a>
                        </div>
                        <div class="details">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-white">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/4.png')}}" alt="img">
                            <a class="tag-base tag-orange" href="#">Food</a>
                        </div>
                        <div class="details">
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="post-slider owl-carousel">
                        <div class="item">
                            <div class="trending-post">
                                <div class="single-post-wrap style-overlay">
                                    <div class="thumb">
                                        <img src="{{asset('assetsFontend/img/post/5.png')}}" alt="img">
                                    </div>
                                    <div class="details">
                                        <div class="post-meta-single">
                                ...
                                <div class="single-post-wrap style-overlay">
                                    <div class="thumb">
                                        <img src="{{asset('assetsFontend/img/post/6.png')}}" alt="img">
                                    </div>
                                    <div class="details">
                                        <div class="post-meta-single">
                                            <p><i class="fa fa-clock-o"></i>December 26, 2018</p>
                                ...
                                <div class="single-post-wrap style-overlay">
                                    <div class="thumb">
                                        <img src="{{asset('assetsFontend/img/post/7.png')}}" alt="img">
                                    </div>
                                    <div class="details">
                                        <div class="post-meta-single">
                                            <p><i class="fa fa-clock-o"></i>December 26, 2018</p>
                        ...
                        <div class="item">
                            <div class="trending-post">
                                ...
                                <div class="single-post-wrap style-overlay">
                                    <div class="thumb">
                                        <img src="{{asset('assetsFontend/img/post/7.png')}}assets/img/post/7.png" alt="img">
                                    </div>
                                    <div class="details">
                                        <div class="post-meta-single">
                                            <p><i class="fa fa-clock-o"></i>December 26, 2018</p>
                    ...
                    <div class="post-slider owl-carousel">
                        <div class="item">
                            <div class="single-post-list-wrap">
                                <div class="media">
                                    <div class="media-left">
                                        <img src="{{asset('assetsFontend/img/post/list/1.png')}}assets/img/post/list/1.png" alt="img">
                                    </div>
                            ...
                            <div class="single-post-list-wrap">
                                <div class="media">
                                    <div class="media-left">
                                        <img src="{{asset('assetsFontend/img/post/list/2.png')}}" alt="img">
                                    </div>
                                    <div class="media-body">
                                        <div class="details">
                                            <div class="post-meta-single">
                            ...
                            <div class="single-post-list-wrap">
                                <div class="media">
                                    <div class="media-left">
                                        <img src="{{asset('assetsFontend/img/post/list/3.png')}}" alt="img">
                                    </div>
                                    <div class="media-body">
                                        <div class="details">
                                            <div class="post-meta-single">
                            ...
                            <div class="single-post-list-wrap">
                                <div class="media">
                                    <div class="media-left">
                                        <img src="{{asset('assetsFontend/img/post/list/4.png')}}" alt="img">
                                    </div>
                                    <div class="media-body">
                                        <div class="details">
                                            <div class="post-meta-single">
                            ...
                            <div class="single-post-list-wrap">
                                <div class="media">
                                    <div class="media-left">
                                        <img src="{{asset('assetsFontend/img/post/list/5.png')}}" alt="img">
                                    </div>
                                    <div class="media-body">
                                        <div class="details">
                                            <div class="post-meta-single">
                        ...
                        <div class="item">
                            <div class="single-post-list-wrap">
                                <div class="media">
                                    <div class="media-left">
                                        <img src="{{asset('assetsFontend/img/post/list/1.png')}}" alt="img">
                                    </div>
                                    <div class="media-body">
                                        <div class="details">
                                            <div class="post-meta-single">
                    ...
                    <div class="post-slider owl-carousel">
                        <div class="item">
                            <div class="single-post-wrap">
                                <div class="thumb">
                                    <img src="{{asset('assetsFontend/img/post/8.png')}}" alt="img">
                                </div>
                                <div class="details">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="add-area">
                        <a href="#"><img class="w-100" src="{{asset('assetsFontend/img/add/6.png')}}g" alt="img"></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay-bg">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/9.png')}}" alt="img">
                        </div>
                        <div class="details">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/10.png')}}" alt="img">
                    ...
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/11.png')}}" alt="img">
                            <p class="btn-date"><i class="fa fa-clock-o"></i>08.22.2020</p>
                        </div>
                        <div class="details">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/12.png')}}" alt="img">
                            <p class="btn-date"><i class="fa fa-clock-o"></i>08.22.2020</p>
                        </div>
                        <div class="details">
                    ...
                    <div class="single-post-wrap">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/13.png')}}" alt="img">
                            <p class="btn-date"><i class="fa fa-clock-o"></i>08.22.2020</p>
                        </div>
                        <div class="details">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/15.png')}}" alt="img">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/16.png')}}" alt="img">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/17.png')}}" alt="img">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/18.png')}}" alt="img">
                            <a class="tag-base tag-purple" href="#">Tech</a>
                        </div>
                        <div class="details">
                            <div class="post-meta-single">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/19.png')}}" alt="img">
                            <a class="tag-base tag-red" href="#">Tech</a>
                        </div>
                        <div class="details">
                            <div class="post-meta-single">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/20.png')}}" alt="img">
                            <a class="tag-base tag-blue" href="#">Tech</a>
                        </div>
                        <div class="details">
                            <div class="post-meta-single">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/21.png')}}" alt="img">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single-post-wrap style-overlay">
                        <div class="thumb">
                            <img src="{{asset('assetsFontend/img/post/22.png')}}" alt="img">
                            <a class="tag-base tag-blue" href="#">Tech</a>
                        </div>
                        <div class="details">
                            <div class="post-meta-single">
